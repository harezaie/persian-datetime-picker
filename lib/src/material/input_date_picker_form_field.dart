...
class PersianInputDatePickerFormField extends StatefulWidget {
  ...
  @override
  State<PersianInputDatePickerFormField> createState() =>
      _InputDatePickerFormFieldState();
}

class _InputDatePickerFormFieldState
    extends State<PersianInputDatePickerFormField> {
    ...
    return Semantics(
      ...
      child: TextFormField(
        decoration: InputDecoration(
          ...
          inputTheme
              .merge(datePickerTheme.inputDecorationTheme as InputDecorationThemeData?)
